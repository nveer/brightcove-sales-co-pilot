...
3. Update the SE_USER_IDS in `gong_api.sh` with your team's actual Gong user IDs
...
- For SE best practices research, pass 24-36 as months_back
...
## Critical Rules
1. **ALWAYS filter by SE user IDs** from `/context/se_team.md`
